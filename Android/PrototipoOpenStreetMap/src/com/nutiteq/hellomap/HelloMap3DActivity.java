...
public class HelloMap3DActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // rotation - 0 = north-up
        //FIXME check this line, and try to un comment without lint errors OR invest what exactly does supressLint
        ...
        mapView.getOptions().setPersistentCacheSize(200 * 1024 * 1024);
