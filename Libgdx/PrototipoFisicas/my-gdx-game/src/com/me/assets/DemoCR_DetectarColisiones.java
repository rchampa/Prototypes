...
public class DemoCR_DetectarColisiones extends ApplicationAdapter implements ContactListener {
	...
	private void createBalls() {
		...
		for (int i=0; i<MAX_BALLS; i++) {
			...
			ballModels.add(aux);//ballModels[i] = world.createBody(ballBodyDef);
	...
	public void beginContact(Contact contact) {
		System.out.println("contactooooo!");
