...
public class MiApp extends ApplicationAdapter {
	...
	public void create() {
		...
		int x_gravity=0;
		int y_gravity= -10;//falling "to" down
	...
	public void render() {
		...
		//tweenManager.update(1/300f);//Setting delta time
		world.step(1/60f, 10, 10);
		//world.step(1/300f, 10, 10);
		...
		Tween.call(new TweenCallback() {
			...
			public void onEvent(int arg0, BaseTween<?> arg1) {
				if (idx < ballModels.length) {
					ballModels[idx].setAwake(true);//no clue about what means sleep state
