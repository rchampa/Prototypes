...
public class MainActivity extends MapActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapsFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/graphhopper/maps/";
    ...
    private void chooseAreaFromLocal() {
        ...
        loadchooseArea(localButton, localSpinner, nameList,
    	...
    	new MyAsyncTask<Void, Void, List<String>>() {
            ...
            protected void onPostExecute(List<String> nameList) {
                ...
                MySpinnerListener spinnerListener = new MySpinnerListener() {
                    @Override
                    public void onSelect(String selected) {
                        if (selected == null || new File(mapsFolder + currentArea + ".ghz").exists() || new File(mapsFolder + currentArea + "-gh").exists()) {
                            downloadURL = null;
                        } else {
                ...
                loadchooseArea(remoteButton, remoteSpinner, nameList,
                        spinnerListener);
            }
        }.execute();
    }

    private void loadchooseArea(Button button, final Spinner spinner, List<String> nameList, final MySpinnerListener mylistener) {
        ...
        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, nameList);
    ...
    void downloadingFiles() {
        ...
        new MyAsyncTask<Void, Integer, Object>() {
            protected Object saveDoInBackground(Void... _ignore)
                ...
                AndroidHelper.download(downloadURL, localFile, new ProgressListener() {
                            @Override
    ...
    void unzipping() {
        ...
        final boolean uncompress = compressed.exists() && !compressed.isDirectory();
        if (!uncompress) {
            loadMap();
            return;
        }
        ...
        new AsyncTask<Void, Void, GHResponse>() {
            ...
            protected GHResponse doInBackground(Void... v) {
                ...
                GHRequest req = new GHRequest(fromLat, fromLon, toLat, toLon)
                        .algorithm("dijkstrabi").minPathPrecision(1d)/*putHint("douglas.minprecision", 1d)*/;
